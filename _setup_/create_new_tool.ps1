...
# parent directory of the qt-tool-template
$TOOLS_DIR = (Get-Item -Path "..\").FullName

# define current tool name variables
$CURRENT_base_case = "tool-name"
$CURRENT_snake_case = "tool_name"
$CURRENT_PascalCase = "ToolName"
...
Foreach-Object {
    ...
    ((Get-Content -path $_.FullName -Raw) -replace "qt-tool-template", $NEW_base_case) | Set-Content -Path $_.FullName
